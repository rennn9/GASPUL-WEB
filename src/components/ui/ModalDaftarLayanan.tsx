...
//       <div className="overflow-y-auto flex-1 pr-1 mb-6">
//         {layanan?.length ? (
//           <ul className="space-y-3">
//             {layanan.map((item, i) => (
// <li
//   key={i}
//   className="p-3 bg-gray-100 rounded-xl text-gray-800 flex items-center justify-between gap-4"
// >
...
//           </ul>
//         ) : (
//           <p className="text-gray-600 text-center">Belum ada layanan terdaftar.</p>
//         )}
//       </div>
//     </motion.div>
//   </motion.div>
